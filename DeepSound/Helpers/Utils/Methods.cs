                ...
                case ErrorObject error:
                    {
                        ...
                        if (errorText.Contains("logged in") || errorText.Contains("Session does not exist"))
...
#pragma warning restore 618
            ...
            public static void OpenAppByPackageName(Context context, string packageName, string type)
            {
                try
                {
                    Intent intent;
...
#pragma warning restore 618
        ...
        public class CapturePhotoUtils
        {
            ...
            {
                var source = BitmapUtil.GetImageBitmapFromUrl(path);
