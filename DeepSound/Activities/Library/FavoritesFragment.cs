    ...
    public class FavoritesFragment : Fragment
    {
        ...
        private void InitToolbar(View view)
        {
            try
            {
                ...
                GlobalContext.SetToolBar(toolbar, GetString(Resource.String.Lbl_Favorites));
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        private void ShowEmptyPage()
        {
            try
            {
                ...
                { 
                    ...
                    GlobalContext?.LibrarySynchronizer?.AddToFavorites(MAdapter.SoundsList.FirstOrDefault(),MAdapter.ItemCount);
                }
                else
                {
