...
namespace DeepSound.Activities.SettingsUser.InviteFriends.Adapter
{
    public class InviteFriendsAdapter : RecyclerView.Adapter
    {
        ...
        public ObservableCollection<Methods.PhoneContactManager.UserContact> MUsersPhoneContacts = new ObservableCollection<Methods.PhoneContactManager.UserContact>();
