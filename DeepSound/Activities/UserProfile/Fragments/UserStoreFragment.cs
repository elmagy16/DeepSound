...
{
    public class UserStoreFragment : Fragment
    {
        ...
        private HSoundAdapter MAdapter;
        ...
        private void SetRecyclerViewAdapters()
        {
            try
            {
                MAdapter = new HSoundAdapter(Activity) { SoundsList = new ObservableCollection<SoundDataObject>()};
